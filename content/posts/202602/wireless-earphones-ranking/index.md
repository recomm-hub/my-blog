...
{{< callout type="info" title="価格について" >}}
...
flowchart TD
    ...
    A --> C["Android"]
    B --> D{"予算は？"}
    D --> E["3万円以上"] --> F["\u2705 AirPods Pro 3"]
    D --> G["2万円以下"] --> H["\u2705 WF-C710N"]
    D --> I["1万円以下"] --> J["\u2705 Anker Liberty 4 NC"]
    C --> K{"予算は？"}
    K --> L["3万円以上"] --> M["\u2705 WF-1000XM5"]
    K --> N["2万円前後"] --> O["\u2705 LinkBuds S"]
    K --> P["1万円以下"] --> Q["\u2705 Anker Liberty 4 NC"]
```

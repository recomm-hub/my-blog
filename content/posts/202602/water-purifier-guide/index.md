...
結論から言うと、日本の水道水はそのまま飲んでも安全です。水道法で51項目もの水質基準が定められていて、世界的に見てもかなり厳しい基準をクリアしています。
...
**タンク型**はポット型の大容量版。{{< amazon-link "BRITA Flow" >}}が代表的で、容量が4L以上あるのでキッチンに置いておけば家族で使っても頻繁に補充しなくて済みます。冷蔵庫には入らないサイズなので、常温で使う前提になります。実際に使ってみた感想は[BRITA Flowのレビュー記事](/posts/brita-water-purifier/)にまとめています。実際に使ってみた感想は[BRITA Flowのレビュー記事](/posts/brita-water-purifier/)にまとめています。
...
「で、自分にはどっちがいいの？」という話ですが、以下のフローで考えるとシンプルです。

**🔀 タイプ選び判定フロー**

1. 料理（炊飯・味噌汁・パスタ茹で等）でも浄水を使いたい？
   - **Yes** → 蛇口直結型がラク。いちいちポットから注ぐのは面倒です
   - **No（飲み水だけ）** → 2へ
2. 使う人数は？
   - **1〜2人** → ポット型で十分
   - **3人以上** → タンク型（BRITA Flowなど）か蛇口直結型
3. 冷たい水がいい？
   - **Yes** → ポット型（冷蔵庫に入れておける）
   - **どっちでも** → タンク型 or 蛇口直結型

ぶっちゃけ、どのタイプを選んでも「水道水そのまま」よりは確実においしくなります。迷ったら**まずポット型を買ってみる**のが一番リスクが低いです。2,000〜3,000円くらいなので、合わなくても痛くない。

自分の場合は、最初に{{< amazon-link "BRITA ポット型 浄水器" >}}を買って「あ、浄水ってこんなに違うんだ」と実感してから、料理にも使いたくなって蛇口直結型に切り替えました。<!-- TODO: 実体験 -->いきなり高いのを買うより、段階的に試すほうが失敗しにくいと思います。

---

## ランニングコストで比べると差が出る

浄水器を選ぶとき、本体価格だけ見て決めるのはもったいないです。**長く使うものだからこそ、ランニングコストで比べる**のが大事。
...
うちは{{< amazon-link "BRITA Flow" >}}を使っていますが、カートリッジ代は月300円ちょっと（[詳しいコスト内訳はこちら](/posts/brita-water-purifier/#brita-flowのランニングコスト)）。ペットボトルを箱買いしてた頃と比べると、ゴミの量も激減しました。<!-- TODO: 実体験 -->地味にこっちのメリットのほうが大きかったりします。重いペットボトルを玄関から運ぶ作業がなくなったのも助かってます。

---

## フィルター交換をサボると起きること

浄水器を買ったら終わりじゃなくて、**フィルター（カートリッジ）の交換が一番大事**です。ここを適当にすると、浄水器をつけてる意味がなくなります。

フィルターは使い続けると浄水性能が徐々に落ちていきます。活性炭やイオン交換膜が不純物を吸着する仕組みなので、吸着できる量には限界があるんですよね。

で、怖いのが**使用期限を大幅に過ぎたフィルターをそのまま使い続けるケース**。フィルター内部に溜まった不純物をエサに雑菌が繁殖して、水道水をそのまま飲むより不衛生になる可能性があります。「浄水器つけてるから安心」と思いがちですが、交換をサボると逆効果です。
